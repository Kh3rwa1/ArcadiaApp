...
const GAME_CATALOG: Game[] = [
    ...
    },
    {
        ...
        game_url: `${API_BASE}/games/durra-bird/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Action',
        trending: true,
    ...
    },
    {
        ...
        game_url: `${API_BASE}/games/durra-blocks/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Arcade',
        trending: true,
    ...
    },
    {
        ...
        description: 'Interstellar lane runner with warp boosts and meteor dodges.',
        game_url: `${API_BASE}/games/stellar-sprint/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Arcade',
        trending: true,
    ...
    },
    {
        id: 'titan-brawler',
        title: 'Titan Brawler',
        description: 'Arena brawler against titan drones with combo strikes.',
        game_url: `${API_BASE}/games/titan-brawler/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Action',
        trending: true,
    ...
    },
    {
        id: 'prism-pulse',
        title: 'Prism Pulse',
        description: 'Color pulse puzzle where you sync beats to break prisms.',
        game_url: `${API_BASE}/games/prism-pulse/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Puzzle',
        trending: false,
    ...
    },
    {
        id: 'turbo-skater',
        title: 'Turbo Skater',
        description: 'Neon half-pipe run with trick chains and speed bursts.',
        game_url: `${API_BASE}/games/turbo-skater/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Endless',
        trending: true,
    ...
    },
    {
        id: 'mech-defender',
        title: 'Mech Defender',
        description: 'Hold the core with tactical turret timing and shield dashes.',
        game_url: `${API_BASE}/games/mech-defender/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Strategy',
        trending: true,
    ...
    },
    {
        id: 'skyforge-raid',
        title: 'Skyforge Raid',
        description: 'Sky fortress raid with aerial dodges and precision blasts.',
        game_url: `${API_BASE}/games/skyforge-raid/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Action',
        trending: true,
    ...
    },
    {
        id: 'orbit-smash',
        title: 'Orbit Smash',
        description: 'Orbital smash challenge with gravity wells and quick reactions.',
        game_url: `${API_BASE}/games/orbit-smash/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Arcade',
        trending: false,
    ...
    },
    {
        id: 'pixel-assault',
        title: 'Pixel Assault',
        description: 'Retro-future assault run with pixel-perfect dodging.',
        game_url: `${API_BASE}/games/pixel-assault/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Action',
        trending: true,
    ...
    },
    {
        id: 'rune-rush',
        title: 'Rune Rush',
        description: 'Rune chain rush mixing memory lanes and rapid decisions.',
        game_url: `${API_BASE}/games/rune-rush/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Brain',
        trending: false,
    ...
    },
    {
        ...
        description: 'Hyper-speed vortex escape packed with tight turns.',
        game_url: `${API_BASE}/games/velocity-vortex/v1/index.html`,
        version: 'v1.0.0',
        creator: 'DURRA Labs',
        category: 'Endless',
        trending: true,
...

    {
        ...
        description: 'Endless runner with fast reflex play and short run sessions.',
        game_url: `${API_BASE}/games/subway-surfers/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Endless',
        trending: true,
        likes: 21400,
        plays: 88500,
    },
    {
        ...
        description: 'Rhythm-based jumps, tiny levels, huge replay value.',
        game_url: `${API_BASE}/games/geometry-dash-world/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Rhythm',
        trending: true,
    ...
    },
    {
        id: 'hole-io',
        title: 'Hole.io',
        description: 'Eat everything in sight and grow bigger in short chaotic rounds.',
        game_url: `${API_BASE}/games/hole-io/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Arcade',
        trending: true,
    ...
    },
    {
        id: 'mob-control',
        title: 'Mob Control',
        description: 'Launch crowds and capture bases for immediate silly fun.',
        game_url: `${API_BASE}/games/mob-control/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Strategy',
        trending: true,
    ...
    },
    {
        id: 'snake-clash',
        title: 'Snake Clash!',
        description: 'Classic snake movement with modern twists for snack-play sessions.',
        game_url: `${API_BASE}/games/snake-clash/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Arcade',
        trending: false,
    ...
    {
        id: 'space-shooter-galaxy-attack',
        title: 'Space Shooter – Galaxy Attack',
        description: 'Classic shoot’em-up bursts packed with enemy waves.',
        game_url: `${API_BASE}/games/space-shooter-galaxy-attack/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Action',
        trending: true,
    ...
    {
        id: 'galaxiga-arcade',
        title: 'Galaxiga: Galaxy Arcade Game',
        description: 'Retro-style shooter action wave after wave.',
        game_url: `${API_BASE}/games/galaxiga-arcade/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Action',
        trending: true,
    ...
    {
        id: 'rise-up-balloon',
        title: 'Rise Up: Balloon Game',
        description: 'One-touch control with short survival rounds.',
        game_url: `${API_BASE}/games/rise-up-balloon/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Casual',
        trending: false,
    ...
    {
        id: 'bouncemasters-penguin',
        title: 'Bouncemasters: Penguin Games',
        description: 'Physics yanks and quick distance levels.',
        game_url: `${API_BASE}/games/bouncemasters-penguin/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Physics',
        trending: false,
    ...
    },
    {
        ...
        description: 'Fast arcade flying action with dense enemy squadrons.',
        game_url: `${API_BASE}/games/air-force-1945/v1/index.html`,
        version: 'v1.0.0',
        creator: 'Arcadia Originals',
        category: 'Action',
        trending: true,
